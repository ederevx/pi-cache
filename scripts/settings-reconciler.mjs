 ...
 * only it. This reconciler runs from postinstall after any package
 * install or pinned-ref update and drops duplicate package entries,
...
export class SettingsReconciler {
	...
	/** Drops every the package entry but one. Returns the dropped entries,
